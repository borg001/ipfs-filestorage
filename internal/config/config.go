...
type AuthConfig struct {
	...
	// LuaAllowedPrivateHosts is a comma-separated list of hostnames that may resolve to private IPs.
	LuaAllowedPrivateHosts string
...
func Load() *Config {
	...
	return &Config{
		...
		Auth: AuthConfig{
			...
			LuaAllowedPrivateHosts: getEnv("AUTH_LUA_ALLOWED_PRIVATE_HOSTS", ""),
